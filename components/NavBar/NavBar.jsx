...
import { AiOutlineInbox, AiFillHome, AiOutlineMenu } from "react-icons/ai";
import { FaMoon, FaSun } from "react-icons/fa";
import {IoIosArrowDown} from 'react-icons/io'

import {AboutUsFeatures} from './NavBarAboutUs'
import {OurProjectsFeatures} from './NavBarOurProjects'
import {ServicesFeatures} from './NavBarServices'
...
export default function NavBar(props) {
  ...
  // }, [scrollY]);
  const cl = useColorModeValue("gray.800", "gray.200");
  ...
  return (
    <>
      ...
      >
        <chakra.div h="4.5rem" mx="auto" px={8}>
          <Flex
            w="full"
            h="full"
            alignItems="center"
