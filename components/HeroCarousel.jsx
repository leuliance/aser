...
const HeroCarousel = () => {
  ...
  const slides = [
    {
      img:
        "https://images.unsplash.com/photo-1598940603846-a1edd0ef2574?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=375&q=80",
      label: "Aser Construction",
  ...
  return (
    <Flex
      ...
      px={4}
    >
      <Flex h="full"  rounded={10} w="full" pos="relative" overflow="hidden">
        <Flex h="530px" w="full" {...carouselStyle}>
          {slides.map((slide, sid) => (
            <Box key={`slide-${sid}`} boxSize="full" shadow="md" flex="none">
              ...
              <Stack
                ...
                color="white"
              >
                <Text fontSize="6xl">{slide.label}</Text>
                <Text color="yellow" fontSize="2xl">{slide.description}</Text>
              </Stack>
            </Box>
          ))}
        </Flex>
